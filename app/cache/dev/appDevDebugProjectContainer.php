...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_1' => 'get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d321Service',
            '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_2' => 'get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d322Service',
            '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_3' => 'get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d323Service',
            ...
            'd1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d_1' => 'getD1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d1Service',
    ...
    /**
     * Gets the '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_1' service.
     *
     ...
     */
    protected function get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d321Service()
    {
        return $this->services['4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d322Service()
    {
        return $this->services['4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d323Service()
    {
        return $this->services['4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/MAMP/htdocs/BeaverFather/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'd1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getD1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d1Service()
    {
        return $this->services['d1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_76381a81d50612fd0c45b685f2db57ca40c9ec9d6b753662bc407dd628fe7938');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_76381a81d50612fd0c45b685f2db57ca40c9ec9d6b753662bc407dd628fe7938');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_76381a81d50612fd0c45b685f2db57ca40c9ec9d6b753662bc407dd628fe7938');
        ...
        $d->setProxyDir('/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/MAMP/htdocs/BeaverFather/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('d1a8f6b7a8bafdac6bdd8646fc23634ff6daf6c3cc260dea49921f2ad874543d_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/BeaverFather/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/MAMP/htdocs/BeaverFather/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_1'), 1 => $this->get('4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_2'), 2 => $this->get('4505c9597fe2e855f745f679193dce6f00bef33083277faddf1808c9852a3d32_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/MAMP/htdocs/BeaverFather/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/MAMP/htdocs/BeaverFather/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/app/Resources/views');
        $instance->addPath('/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/MAMP/htdocs/BeaverFather/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/MAMP/htdocs/BeaverFather/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/BeaverFather/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/BeaverFather/app/logs',
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/MAMP/htdocs/BeaverFather/app/../web',
            'assetic.write_to' => '/Applications/MAMP/htdocs/BeaverFather/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/BeaverFather/app/cache/dev/doctrine/orm/Proxies',
